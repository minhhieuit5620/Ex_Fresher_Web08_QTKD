        ...
        <div class="inner__content">
            ...
            <div class="content__data">
                <table class="table">
                    <thead>
                        <tr>
                            <th><input class="input__checkbox" type="checkbox" /> </th>
                            <th>Mã nhân viên</th>
                            <th>Tên nhân viên</th>
                            <th>Giới tính</th>
                            <th>Ngày sinh</th>
                            ...
                            <th class="column__edit column__edit--th">Chức năng</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for=" (item, index) in employee" :key="item.EmployeeId" >
                            <td > <input type="checkbox" class="input__checkbox checkbox__item" /></td>
                            ...
                            <td class="edit__td column__edit" style="width: 100px" :ref="'row_'+index"> 
                                    Sửa
